...
define showgirl = Character("Daisy", what_font="Play-Regular.ttf", window_style = "ig_window", what_style = "ig_dial", namebox_xpos = 250, namebox_ypos = 50, who_color = "#000000", what_color = "#000000", image = "daisy stream", window_background="images/textbox/stream textbox npc.png")
