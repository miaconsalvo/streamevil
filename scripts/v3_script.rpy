...
label vig3_sc12():
    ...
    ama "I suggest you watch that mouth of yours."
    ...
    ama "All that struggle. All that runnin'"
    ama "Was it worth it?"
    "I looked at MAC and then Ama."
    "Before I even realize it, I start walking towards her."
    ama "Woah now, stay right there."
    "I take another step."
    ama "I'm warnin' ya Mozely."
    "She's hesitating."
    "Another step."
    ama "You're gonna make me shoot you?"
...
label vig3_sc13():
    ...
    pS "It's some good-lookin' work."
    recS "Just like his muscles"
    mS "..."
    ...
    menu: 
        ...
        "Mad Dash to the shuttles.":
            ...
            "Like a little puple battering ram MAC was clearing a path through just as Reynar's security came to intercept us."
            pS "Jeez this kid's goin fast and furious."
            enS "He gets it from you."
            recS "This architecure is incredible, so seemless is the tech integrated into the material of the wall."
            mS "REC LOOK FORWARD."
            "Only narrowly missing the fourth downed guard we push forward."
