...
label vig3_sc13():
    ...
    menu: 
        ...
        "Mad dash to the shuttles.":
            ...
            mS "REC LOOK FORWARD!"
            "Rec hops just in time to narrowly miss the fourth downed guard we push forward."
...
label vig3outlawcomms():
    ...
    "Matticus smiles in that shit-eating grin that he loves to flash."
    ...
    recS "You remember I'm the older one right?"
    smatt "Hard to tell when Allistar had the nerve."
    mS "Matticus focus!"
    ...
    recS "Reynar has quite the impressive system here."
    smatt "Okay okay since you did such a good job."
    smatt "I'll make sure Reynar's airspace will be especially hostile."
    mS "Fabulous."
    smatt "Aren't I?"
    smatt "Bye bye and try not to die. I'll be looking for you to repay this favour."
    "The comms go dead."
    mac "Skeeve."
    recS "The biggest."
...
label vig3marshalcomms():
    ...
    enS "Where's the kid?"
    smatt "Ever since you fucked up the job with Sallent I had to restablish the pecking order around here."
    smatt "So I had to make an example."
    "This rat bastard."
    mS "That's low even for you."
    enS "How do you sleep at night?"
    smatt "On a king bed after a big meal."
    smatt "I think we're done here. And Mozely."
    smatt "From the bottom of my heart."
    smatt "I hope Deadeye skins your crew alive while you're forced to watch."
    smatt "Bye bye now!"
    "The comms go dead."
    mac "Skeeve."
    recS "The biggest."
    mS "Let's get out of here."
    "Carefully we make it to the shuttles. Not sure what awaits us on the other. "
    jump vig3_sc14



#Fireworks and Reynar on his balcony. 
