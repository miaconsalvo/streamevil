...
label vig3_sc2():
    ...
    pS "A while..."
    dflycontact "...at a planet known as [static] sector, coordinates [static] message [static] lost [static] reattempt [static] five days. Over and [static]."
    ...
    mS "We should be used to a tightschedule by now."
    ...
    mS "Let's consider our options, come up with a plan to get our Comms back in working order. Meet in the HUB in an hour to debrief."
    ...
    "I turn to the door and go out into the hall. I'm stopped my tiny purple metal leaf."
    #hide cockpit_stream
    show ship_hallway_stream at topleft onlayer background with dissolve
    macS "Captain."
    show mac stream neutral at stream_center_mac with dissolve
    "I'm is startled by MAC's interception."
...
label vig3_sc3():
    ...
    "Well off to side of the road, the familiar busy streets of Akar happen behind us."
    ...
    pS "Moze why'd ya bring us here? Fancy getting caught by Ama?"
    ...
    pS "I think you're gettin' too nostalgic."
    enS "And eager to get arrested."
    mS "Well a BigCorp prison probably has better food than some of the places we've seen."
    macS "There doesn't seem to be many enforcers operating here from what I see."
    ...
    "Just then a small kid walks by with his parents carrying a giant cotton candy dessert. It looks like a planet being orbited by small chocolate moons." ###The candy could change based on alignment###
    ...
    "I can here footsteps rushing to us. He's not alone. I pull my gun in the direction of the sound."
    #show houndgoon stream neutral at stream_center with dissolve 
    "Two tough guys back away."
    mS "Not likely boys."
...
label vig3_sc4():
    ...
    #show akarstreet_stream at topleft onlayer background with dissolve   
    "We arrive at the storefront of Specs and Steele, a small body shop that sells a myriad of goods for ship repair and upgrades."
    ...
    "We walk into Specs and Steele the inside in unsurprisingly a chaotic mess of equipment and gear stacked wildly against the walls."
    ...
    hide mac with dissolve
    "With MAC trailing us I can spot some newer gear off the sides even some weirder stuff, weird for Steele."
    ...
    #Just a courier bot we found and outfitted figured we could use an extra hand and a morale boost...
    ...
    recS "Definitely an older model but sheshould still work fine. Need an install?"
    ...
    "There's too long of a pause that I can't think of something fast enough to end. But thankfully I didn't have to as the door swings open."
    hide mac with dissolve
    hide jennica with dissolve
    ...
    "A small one moves up, next to the big guy she's the next toughest and looks like she has something to prove."
    ...
    houndleader "Finally someone reasonable."
    "We stand back as the group rummages through the store, knocking over shelves and taking random items." 
    "They're armed to the teeth and now I understands why Rec is so quick to comply."
    ...
    mS "Contraband? And what classifies and contraband?"
    houndgoon "Whatever we say."
    houndleader "We'll also be taking this."
    "The Hound's leader goes to pick up the antennae for the Coms that's sitting on Rec's store counter. Of course he does..."
    ...
    #(Fight) I get into his face let him pry my gear from my cold dead hands. He smiles and throws the first punch before I can react. It knocks the wind out of me and I hit the ground then impact after impact to my stomach before I can catch my breath. He gets low right to my ear.
    ...
    "They drop a bottle of brandy on the counter and begins to pour it in the glasses."
    "They stop themselves at the fifth and grab an oil can and pour it in giving it to MAC."
    macS "Thank you!"
    recS "They're the Hounds. Reynar's new security detail."
    recS "Usually they're more of nuisance than anything. Shaking down shops bars."
    ...
    "I stop the glass at my lips and nearly drop it. Whipping my head around I almost grab for my gun until I catch Jennica's gaze."
    pS "All right, Cap?"
    "I take a moment to reconcile what I heard and try to calm down."
    mS "Ya, sorry."
...
label vig3_sc5():
    ...
    "At the center is a park area and at its center is a large statue of a man sitting at a tree, staring at an apple in his hand." 
    ...
    pS "Mighty legendary."
    "I'm taken back to a time long passed. The plaza several years back, rowdy and riotous."
    ...
    "I fire a shot and hit the statue."
    mS "Okay okay, you're in ahahaha!"
    ...
    amaS "...You bet?"
    "I jumps and turns around to the direction of the voice this time I make it to my gun."
    "When I come to I realize I scared the young showgirl behind me near to death."
    mS "What?"
    "She is visibly shocked by my sudden reaction, taking her off script."
    ...
    "Daisy hurriedly leaves the scene going to another group to perform the same spiel. I see her carefully get their attention this time."
    ...
    mS "I'm tired is all."
    recS "You know most of the shops are closing for the day. Lets set you up somewhere for the night."
    ...
    "I can't help but look back at Daisy with a small crew of rough-looking folks. Her eyes fixate on the only person whose back is turned to me."
