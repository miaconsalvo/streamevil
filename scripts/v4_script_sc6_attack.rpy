...
label vig4_sc6_attack_1_ama():
    ...
    play backAudio2 "lazerFire.wav" volume 0.1
    ...
    "No enemies on the street. No danger on the rooftops."
...
label vig4_sc6_attack_1_assault_ama():
    ...
    menu:
        ...
        "Open Fire.":
            pass
    mS "Now!"
    play music "soundtrack/saveTheGalaxy.wav" volume 0.8
    ...
    "I hear the tank rumble as it shifts its position." 
    play audio "tankCharge.wav" volume 1.5
    "The sound of a shot charging resonates from its chamber."
...
label vig4_sc6_attack_1_split_ama():
    ...
    play audio "lazer.wav"
    "Ama follows with a blast from her rifle."
    ...
    stop backAudio3 fadeout 3.0
    "A simple maneuver."
    stop backAudio2 fadeout 2.0
    ...
    "Ama claps me on the back."
    amaS "Yes, let's see the vessel we've commandeered!"
    stop music fadeout 2.0
    hide teresa with dissolve
    hide ama with dissolve
    jump vig4_sc6_attack_2_ama
...
label vig4_sc6_attack_1_assault():
    ...
    menu:
        ...
        "I wanted to kill you myself.":
            ...
            play audio "lazerFire.wav" volume 0.8
...
label vig4_sc6_attack_3():
    ...
    menu:
        ...
        "Attack both Dragonflies and BigCorp.":
            ...
            enS "Roger!"
            "Teresa grabs the machine gun controls, and whips them around."
            "The bolts of machine gun rounds tear into soliders: BC enforcers and Dragonflies alike."
            $ AddChatter(vig4_sc6_attack_3_ama_comment36)
